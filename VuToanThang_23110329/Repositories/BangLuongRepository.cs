...
namespace VuToanThang_23110329.Repositories
{
    public class BangLuongRepository
    {
        ...
        private BangLuong MapFromDataRow(DataRow row)
        {
            ...
            {
                MaBangLuong = Convert.ToInt32(row["MaBangLuong"]),
                ...
                GioOT = Convert.ToDecimal(row["GioOT"]),
                PhuCap = Convert.ToDecimal(row["PhuCap"]),
                KhauTru = Convert.ToDecimal(row["KhauTru"]),
                ThueBH = Convert.ToDecimal(row["ThueBH"]),
                ThucLanh = Convert.ToDecimal(row["ThucLanh"]),
